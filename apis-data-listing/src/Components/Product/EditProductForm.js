...
const EditProductForm = () => {
    ...
    const [productData, setProductData] = useState({
        ...
        actualPrice: location.state.actualPrice,
    ...
    const submit = async (e) => {
        if(productData.category && productData.title && productData.description && productData.price && productData.actualPrice && productData.stock && productData.image.length > 0){
        e.preventDefault()
        ...
        dataOfProduct.append('_id', location.state._id)
        Array.from(productData.image).map((file) => {
            dataOfProduct.append('image', file)
        })
            const data = await axios.post('http://localhost:5000/apis/products/updateproduct', dataOfProduct)
            navigate("/")
            setError(false)
        }
        else{
    ...
    return (
        <>
            <div className="w-full p-[1%] bg-[#F2F3F2] dark:bg-[#101014] dark:text-white">
                <form class="w-[70%] mx-auto gap-4">
                    <div className="w-full p-[1%] mb-[5%] mt-[5%] flex items-center justify-center">
                        <p className="text-4xl hubot font-bold">Edit Product Details</p>
                    </div>
                  {error && <p className='text-[#ff1919] hubot text-lg'>Something is Wrong! Try Again</p>}
                    <div class="relative z-0 w-full mb-[7%] group">
                        <input value={productData.category} type="text" onChange={(event) => { setProductData(prevValue => ({ ...prevValue, category: event.target.value })) 
                    ...
                    <div class="relative z-0 w-full mb-[7%] group">
                        <input value={productData.title} type="text" onChange={(event) => { setProductData(prevValue => ({ ...prevValue, title: event.target.value }))
                    setError(false) }} class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full mb-[7%] group">
                        <input value={productData.description} type="text" onChange={(event) => { setProductData(prevValue => ({ ...prevValue, description: event.target.value })) 
                    setError(false)}} class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full mb-[7%] group">
                        <input value={productData.price} type="number" onChange={(event) => { setProductData(prevValue => ({ ...prevValue, price: event.target.value }))
                    setError(false) }} class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full mb-[7%] group">
                        <input value={productData.actualPrice} type="number" onChange={(event) => { setProductData(prevValue => ({ ...prevValue, actualPrice: event.target.value }))
                    setError(false) }} class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full mb-[7%] group">
                        <input value={productData.stock} type="tel" onChange={(event) => { setProductData(prevValue => ({ ...prevValue, stock: [event.target.value] }))
                    setError(false) }} class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full mb-[7%] group">
                        <input value={productData.rating} type="tel" onChange={(event) => { setProductData(prevValue => ({ ...prevValue, rating: [event.target.value] })) 
                    setError(false)}} class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <button onClick={submit} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-large rounded-lg text-lg w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                </form>
            </div>
        </>)
}
