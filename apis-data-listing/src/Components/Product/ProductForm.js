...
import { createProduct } from "../../Utils/Hooks/UseApi/useApi";
            ...
            <div className="w-full p-[1%]">
                <form class="w-[70%] mx-auto gap-4">
                    <div className="w-full p-[1%] mb-[5%] mt-[5%] flex items-center justify-center">
                        <p className="text-4xl IBM font-bold">Create your product</p>
                    </div>
                    <div class="relative z-0 w-full mb-[7%] group">
                        <input type="text" onChange={(event) => {setProductData(prevValue => ({...prevValue,category:event.target.value}))}} class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full mb-[7%] group">
                        <input type="text" onChange={(event) => {setProductData(prevValue => ({...prevValue,title:event.target.value}))}} class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full mb-[7%] group">
                        <input type="text" onChange={(event) => {setProductData(prevValue => ({...prevValue,description:event.target.value}))}} class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full mb-[7%] group">
                        <input type="number" onChange={(event) => {setProductData(prevValue => ({...prevValue,price:event.target.value}))}} class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                     ...
                     <div class="relative z-0 w-full mb-[7%] group">
                        <input type="number" onChange={(event) => {setProductData(prevValue => ({...prevValue,actualPrice:event.target.value}))}} class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                     ...
                     <div class="relative z-0 w-full mb-[7%] group">
                        <input type="tel" onChange={(event) => {setProductData(prevValue => ({...prevValue,stock:[event.target.value]}))}} class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full mb-[7%] group">
                        <input type="tel" onChange={(event) => {setProductData(prevValue => ({...prevValue,rating:[event.target.value]}))}} class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
