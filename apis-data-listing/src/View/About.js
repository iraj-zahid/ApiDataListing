const About = () => {
    return (
        <>
            <div className="w-full min-h-screen aboutImg">
                <div className="w-full min-h-content pb-[10%] bg-[#0303038c]">
                <div className="w-full flex flex-col items-center justify-center">
                    <div className="w-full p-[10%] flex items-center justify-center">
                        <p className="IBM text-8xl  max-[750px]:text-6xl font-bold text-white">ABOUT US</p>
                    </div>
                    <div className="w-full bg-[#F2F3F2] dark:bg-[#101014] dark:text-white p-[5%] flex max-[750px]:flex-col items-center justify-center">
