            ...
            <div className="w-full min-h-screen contactImg">
                <div className="w-full min-h-content pb-[10%] bg-[#0303038c]">
                    <div className="w-full flex flex-col items-center justify-center">
                        ...
                        <div className="w-full bg-white dark:bg-[#101014] dark:text-white p-[5%] flex max-[750px]:flex-col items-center justify-center">
                            ...
                            <div className="w-[50%] max-[750px]:w-[80%] p-[1%] max-[750px]:py-[4%]">
                                ...
                                <section class="bg-white bg-[#F2F3F2] dark:bg-[#101014]">
                                    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                                        ...
                                        <form action="#" class="space-y-8">
                                            ...
                                            <button type="submit" class="py-3 px-5 text-xl font-medium text-center text-white rounded-lg bg-indigo-600 sm:w-fit hover:bg-indigo-700 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
                                        </form>
                                    </div>
                                </section>
                            </div>
